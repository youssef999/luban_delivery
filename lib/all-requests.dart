...
class AllRequests2 extends StatefulWidget {
...
class _PostsScreenState extends State<AllRequests2> {
  String allposts;
  String v;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Text("جميع الطلبات ",style:TextStyle(color:Colors.green,fontSize:22),),
            SizedBox(height:10),
            Row(
              children: [
                SizedBox(
