...
class OrdersRequest2 extends StatefulWidget {
  String brand_email;

  OrdersRequest2({this.brand_email});
  @override
  _PostsScreenState createState() => _PostsScreenState();
}

class _PostsScreenState extends State<OrdersRequest2> {
  String allposts;
  String v;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Text("الطلبات التي قمت بتغيرها ",style:TextStyle(color:Colors.green,fontSize:22),),
            SizedBox(height:10),
            Row(
              children: [
                SizedBox(
            ...
            Flexible(
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      ...
                      .where("x", isEqualTo:'y').orderBy('time2', descending: true)
                      .snapshots(),
